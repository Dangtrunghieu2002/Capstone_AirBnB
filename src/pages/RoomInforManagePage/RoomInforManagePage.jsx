...
import AdminForm from '../../components/AdminForm/AdminForm'; // Assuming you have an AdminForm for the modal
...
const LocationManagementPage = () => {
    ...
    const {
        ...
        if (selectedLocation) {
            setSelectedLocation((prevLocation) => prevLocation ? { ...prevLocation, hinhAnh: uploadedUrl } : null);
        }
    });
    ...
    const handleFormSubmit = (locationData) => {
        if (selectedLocation) {
            // Edit location
            editLocation(selectedLocation.id, locationData);
        } else {
            // Add new location
