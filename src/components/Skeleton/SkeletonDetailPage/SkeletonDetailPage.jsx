  ...
  return (
    ...
    >
      <div class="py-5 animate-pulse w-full">
        <div class="h-8 bg-gray-200 w-[40%] rounded text-xs"></div>
        <div className="grid grid-cols-4 gap-2 mt-10">
          <div className="h-[410px] w-full bg-gray-200 rounded-lg col-span-2 row-span-2"></div>
        ...
        <div className="mt-10 flex justify-between items-center w-full">
          <div className="w-full space-y-2">
            <div class="h-7 bg-gray-200 w-[35%] rounded text-xs"></div>
            <div class="h-5 bg-gray-200 w-[30%] rounded text-xs"></div>
          </div>
          <div className="w-full gap-2 flex flex-col items-end">
            <div class="h-9 bg-gray-200 w-[25%] rounded text-xs"></div>
            <div class="h-14 bg-gray-200 w-[50%] rounded text-xs"></div>
          </div>
        </div>
      </div>
    </div>
