  ...
  return (
    <div className="flex py-7 px-2 border-b cursor-pointer hover:opacity-80 hover:shadow-lg rounded-lg transition duration-200 ease-out first:border-t">
      ...
      <div className="flex flex-col flex-grow pl-5">
        ...
        <h4 className="text-xl">{item.tenPhong}</h4>

        <div className="border-b w-10 pt-2" />
        <p className="pt-2 text-sm text-gray-500">
          {item.khach} Khách · {item.phongNgu} Phòng ngủ · {item.giuong} Giường
        ...
        <div className="flex justify-between items-end pt-5">
          ...
          <div>
            <p className="text-lg lg:text-2xl font-semibold pb-2">${item.giaTien} / đêm</p>
            <p className="text-right font-extralight">${item.giaTien * 3} Tổng</p>
          </div>
        </div>
      </div>
